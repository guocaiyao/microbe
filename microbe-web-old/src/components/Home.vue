<template>
    <div class="home">
      <div class="data-box">
        <div class="box">
          <div class="left-box">
            <h3>MicroPhenDB<span>（Microbial and Disease Phenotype Database）</span></h3>            
            <div class="sub-title">This is a database resource which collected and curated the human microbe-disease association data.</div>
      ...
      <div class="intro-box">
        <div class="box">
          <h3>What is MicroPhenDB?</h3>
          <div class="content">
            <p>microPhenDB（Microbial and Disease Phenotype Database）is a database resource which collected and curated the human microbe-disease association data. It covers more than 400 diseases including infectious diseases, metabolic diseases and other diseases related to microbial abnormalities, more than 1000 kinds of microorganisms including bacteria, fungi, viruses, parasites and others. Moreover, microPheDB provides microbial information annotations and disease information annotations from EFO ontology.
              Clade-specific marker sequences that are computationally pre-selected from coding sequences that unequivocally identify specific microbial clades at the species or higher taxonomic levels and cover all main functional categories. MicroPheDB provides core-gene sequences and annotations for the identification and functional analysis of pathogenic microorganisms. Integrating microbial high-throughput sequencing data analysis tools to provide pathogenic microbial species identification and pathogenic gene function analysis.
            </p>
          </div>
        </div>
      </div>
