          ...
          <div class="box" id="scrollId" v-if="!isLoading">
              ...
              <div class="model-group" id="Disease">
                ...
                <ul class="content" v-if="Object.keys(data.diseaseData).length!=0">
                  ...
                  <li v-if="data.diseaseData.efoId"><span class="left-title">NCIT ID</span><a :href="data.diseaseData.efoUrl" target="_blank" class="green-a">{{data.diseaseData.efoId}}<i></i></a></li>
                  ...
                  <li v-if="data.pubmed&&data.pubmed.length>0"><span class="left-title">Evidences</span>
                      <ul>
                        <li v-for="(item,index) in data.pubmed" v-bind:key="index">
                          <span>{{index+1}}</span><a :href="item.link" target="_blank" class="green-a">{{data.microbeData.ncitId}}<template v-if="data.microbeData.ncitId"> - </template>{{item.number}}<i></i></a>
                        </li>
                      </ul>
                  </li>
                </ul>
